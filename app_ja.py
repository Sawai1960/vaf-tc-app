...
st.caption("⚠️ 遺伝子リファレンスシステムは **2025年版小杉班指針**（がん遺伝子パネル検査におけるGPV/PGPV対応手順に関する指針 2025版）のT-only検査PGPV開示推奨遺伝子リストに準拠しています。")
...
# 3. 遺伝子リファレンスデータ ― 2025年版小杉班指針(T-only PGPV開示推奨遺伝子 31遺伝子)準拠
GENE_INFO = {
    # 🔴 低VAF閾値グループ(VAF ≥ 10%) ― 特別扱い
    "BRCA1":  ("low_threshold", "🔴 BRCA1 [2025年版小杉班指針]：**VAF ≥ 10%** の低閾値（標準より低い）。低VAFでもGPVの可能性があります。エキスパートパネル検討と生殖細胞系列確認検査を推奨。HBOC。"),
    "BRCA2":  ("low_threshold", "🔴 BRCA2 [2025年版小杉班指針]：**VAF ≥ 10%** の低閾値（標準より低い）。低VAFでもGPVの可能性があります。エキスパートパネル検討と生殖細胞系列確認検査を推奨。HBOC。"),
    # 🟠 年齢条件付きグループ(SNV VAF ≥ 30% / Indel ≥ 20% かつ 発症年齢 < 30歳)
    "APC":    ("age_cond", "🟠 APC [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)かつ大腸ポリポーシス発症 < 30歳** で開示推奨。家族性大腸腺腫症(FAP)。Box_E：表現型評価が必要。"),
    "CDKN2A": ("age_cond", "🟠 CDKN2A [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)かつ発症年齢 < 30歳** で開示推奨。遺伝性黒色腫・膵がん症候群。"),
    "PTEN":   ("age_cond", "🟠 PTEN [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)かつ発症年齢 < 30歳** で開示推奨。Cowden症候群。Box_E：表現型評価が必要。"),
    "RB1":    ("age_cond", "🟠 RB1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)かつ発症年齢 < 30歳** で開示推奨。遺伝性網膜芽細胞腫。Box_E：表現型評価が必要。"),
    "TP53":   ("age_cond", "🟠 TP53 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)かつ発症年齢 < 30歳** で開示推奨。Li-Fraumeni症候群。Box_E：表現型評価が必要。注：高VAFではクローン性造血の可能性も考慮。"),
    # 🟡 標準グループ(SNV VAF ≥ 30% / Indel ≥ 20%) ― 24遺伝子
    "ATM":    ("standard", "🟡 ATM [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC・毛細血管拡張性運動失調症。"),
    "BAP1":   ("standard", "🟡 BAP1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。BAP1腫瘍素因症候群。"),
    "BARD1":  ("standard", "🟡 BARD1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC。"),
    "BRIP1":  ("standard", "🟡 BRIP1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC。"),
    "CHEK2":  ("standard", "🟡 CHEK2 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC。"),
    "DICER1": ("standard", "🟡 DICER1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。DICER1症候群(胸膜肺芽腫など)。"),
    "FH":     ("standard", "🟡 FH [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HLRCC(遺伝性平滑筋腫症・腎細胞がん)。"),
    "FLCN":   ("standard", "🟡 FLCN [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。Birt-Hogg-Dubé症候群。"),
    "MLH1":   ("standard", "🟡 MLH1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。Lynch症候群。"),
    "MSH2":   ("standard", "🟡 MSH2 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。Lynch症候群。"),
    "MSH6":   ("standard", "🟡 MSH6 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。Lynch症候群。"),
    "MUTYH":  ("standard", "🟡 MUTYH [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)・両アレル病的バリアントのみ** で開示推奨。MUTYH関連ポリポーシス。"),
    "NF1":    ("standard", "🟡 NF1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。神経線維腫症1型。Box_E：表現型評価が必要。"),
    "PALB2":  ("standard", "🟡 PALB2 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC。"),
    "PMS2":   ("standard", "🟡 PMS2 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。Lynch症候群。"),
    "POLD1":  ("standard", "🟡 POLD1 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。遺伝性大腸がん。"),
    "POLE":   ("standard", "🟡 POLE [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。遺伝性大腸がん。"),
    "RAD51C": ("standard", "🟡 RAD51C [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC。"),
    "RAD51D": ("standard", "🟡 RAD51D [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。HBOC。"),
    "RET":    ("standard", "🟡 RET [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。多発性内分泌腫瘍症2型(MEN2)。"),
    "SDHA":   ("standard", "🟡 SDHA [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。遺伝性パラガングリオーマ・褐色細胞腫症候群。"),
    "SDHB":   ("standard", "🟡 SDHB [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。遺伝性パラガングリオーマ・褐色細胞腫症候群。"),
    "TSC2":   ("standard", "🟡 TSC2 [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。結節性硬化症。"),
    "VHL":    ("standard", "🟡 VHL [2025年版小杉班指針]：**SNV VAF ≥ 30%(Indel ≥ 20%)** で開示推奨。フォン・ヒッペル・リンダウ症候群。"),
}
...
def get_gene_message(gene):
    ...
    return ("not_listed", f"⬜ {gene}：2025年版小杉班指針のT-only検査PGPV開示推奨遺伝子リストに含まれていません。本指針における生殖細胞系列開示の優先度は低く、体細胞変異の可能性が高いと考えられます。臨床ガイドラインと家族歴による総合的な評価が必要です。")
...
# 遺伝子リファレンス表(2025年版小杉班指針)
with st.sidebar.expander("📖 遺伝子リファレンス(2025年版小杉班指針)"):
    ...
    st.caption("出典：がん遺伝子パネル検査におけるGPV/PGPV対応手順に関する指針2025版(小杉班指針)")
...
with col_alerts:
    ...
    def show_variant_interpretation(g, t, v):
        ...
        # 遺伝子別メッセージ(2025年版小杉班指針)
        _, gene_msg = get_gene_message(g)
        st.info(gene_msg)
        st.caption("💡 注：この解釈はVAF-TCの数理モデルのみに基づいています。遺伝子別の生殖細胞系列確率は2025年版小杉班指針に準拠して別途提示しています。")
